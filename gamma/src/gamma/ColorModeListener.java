...
public class ColorModeListener implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(SettingsFrame.whitemode.isSelected()==true) {
			...
			GraphPanel.graphpaint1 = new GraphPaint(GraphPanel.chart1.createBufferedImage(400, 300));
			...
			GraphPanel.chart2.getTitle().setPaint(new Color(80, 80, 80));
			GraphPanel.graphpaint2 = new GraphPaint(GraphPanel.chart2.createBufferedImage(400, 300));
